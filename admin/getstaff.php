...
<div class="card">
    <div class="card-header bg-info text-white">
        STAFF LIST
        <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"  class="btn bg-warning mr-auto btn-sm"><i class="fa fa-print text-white"> </i> Print Staff List <i class="fa fa-caret-down"></i> </a>
        <ul class="dropdown-menu animated zoomIn" aria-labelledby="exduties" >
            <li class="dropdown-item text-muted" style="cursor:pointer;"><a onclick="print_staff();return false;">Print All Staff</a></li>
            <li class="dropdown-item text-muted" style="cursor:pointer;"><a onclick="hmasters(); return false;">House Masters/Mistresses</a></li>
            <li class="dropdown-item text-muted" style="cursor:pointer;"><a onclick="fmasters()">Form Masters/Mistresses </a></li>
           ...
           while ($row = mysqli_fetch_assoc($data)) {
            ...
            <tr id="sub_<?=$row['id']?>">
                ...
                <td>
                  ...
                  <td><i class="fa fa-chain-broken rmsub btn btn-danger btn-sm" title="Unasign this subject" data-del="delsubj.php" onclick="rmsub(<?=$id?>,<?=$row['id']?>)"  style="color: #F00; cursor: pointer;"></i></td>
            ...
            <div class="card-footer p-0 bg-white">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <i id="exduties" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"  style="color: deepskyblue; cursor: pointer;" data-toggle="tooltip" class="fa fa-plus-square waves-effect waves-circle dropdown-toggle" title="Assign some extra duties to this staff"></i>
                         <ul class="dropdown-menu animated zoomIn" aria-labelledby="exduties" >
                        ...
                        <i class="fa fa-repeat waves-effect waves-circle text-info" title="Reset Password" onclick="respass(<?=$id?>,'<?=$fname?>')"></i>
                        ...
                        <i data-show="<?= (".sub-inf-".$id); ?>" onclick="show_sub(<?=$id?>)" class="fa fa-caret-down waves-effect waves-circle pull-right sub-show" title="View details about this staff" style="color: deepskyblue; cursor: pointer; font-size: 18px;"></i>
                    </div>
                </div>
            </div>
