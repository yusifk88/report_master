<?php
session_start();
if(!$_SESSION['ad_uname'] && !$_SESSION['ad_upass'] && !$_SESSION['ad_id']){
header("location:../");
}
     ...
     <nav class="navbar navbar-expand-md fixed-top bg-info  ">
      <div class="container-fluid">
          <div class="navbar-header" style="transition: .3s ease-in-out !important;">
            ...
            <a class="navbar-brand hidden-md mr-4 float-left" id="nav-back" href="#" ><i class="fa fa-long-arrow-left text-white"> </i></a>
          <a class="navbar-brand hidden-xs hidden-sm text-white m-0" href="#" style="font-weight: bold; color: #fff !important;" onclick="return false;"> <?=$_SESSION['ad_fname']." ".$_SESSION['ad_lname']." [".$_SESSION['ad_utype']."]";?></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav ml-auto ">
              <li class="nav-item text-center" title="Print record entry Log" data-toggle="tooltip"><a  onclick="entrylog(); return false;" style="color: #fff;" href="#" class=" nav-link"><i class="fa fa-arrow-down"></i><i class="fa fa-arrow-up"></i>
                       </a></li>
              <li title="Manage deadline" data-toggle="tooltip" class="nav-item text-center text-white"><a  onclick="setdeadline(); return false;" href="#" class="nav-link"><i class="fa fa-clock-o text-white"></i>
                      </a></li>
              <li class="nav-item text-center"><a onclick="showinfo(); return false;"  class="nav-link text-white"><i class="fa fa-info-circle"></i>
                       </a></li>
              <li class="nav-item text-center text-white"><a id="hlpmnu" onclick="showhelp(); return false;" href="#Help" class="nav-link text-white"><i class="fa fa-lightbulb-o text-white"></i> </a></li>
            <li class="nav-item text-center"><a href="#" onclick="logout(); return false;" class="nav-link"><i class="fa fa-sign-out text-white"></i>
                   </a></li>
            <li class="nav-item text-white text-center"><a id="searchbtn" href="#" onclick="showsearch(); return false;" class="bg-info text-white nav-link"><i style="font-weight: bolder;" class="fa fa-search"></i>

            </a></li>
          </ul>
        </div>
          <button id="menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="navbar-toggler collapsed ml-auto p-0"><i class="fa fa-ellipsis-v navbar-toggler-icon text-white"></i></button>
          <ul class="dropdown-menu animated zoomIn" style="transition: 0.1s ease-in-out !important;" aria-labelledby="menu" >
              <li class="dropdown-item" title="Manage deadline" data-toggle="tooltip"><a  onclick="setdeadline(); return false;"  href="#">View Entry Log</a></li>
              <li class="dropdown-item" title="Manage deadline" data-toggle="tooltip"><a  onclick="setdeadline(); return false;"  href="#">Set Deadline</i></a></li>
          ...
          <button id="searchbtn" onclick="showsearch();" type="button"  class="navbar-toggler collapsed"   aria-expanded="false" aria-controls="navbar">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-6">
                        ...
                        <i class="fa fa-print tile-icon"><sup><i class="fa fa-list-ul"></i></sup></i>
                            <p class="title">Print Broadsheet</p>
                             <small class="detail hidden-sm">
                                 generate and Print a broad performance sheet containing all subjects along with scores...
                             </small>
                        </div>
                                </a>
                              </div>
                             ...
                             <small class="detail visible-lg visible-md">
                              ...
                              <div class="col-lg-3 col-md-3 col-sm-4 col-6">
                                  ...
                                  <div class="tile tile-green" data-id="#print-pool" data-get="frmres">
                                      ...
                                      <div class="detail visible-lg visible-md">
                                          Print a list of students of a certain form ranked by their general performance for the term
                                      </div>
                                  </div>
                                      </a>
                              </div>
  ...
  <div class="tile-group">
      ...
      <div class="col-lg-3 col-md-3 col-sm-4 col-6">
          ...
          <div class="tile tile-violet" data-id="#promtstud" data-get="prmtstud">
                         ...
                         <div class="col-lg-3 col-md-3 col-sm-4 col-6">
                             ...
                             <div onclick="localStorage.addtest='accounts';" class="tile tile-blue" data-id="#print-pool" data-get="accounts">
        ...
        <div class="mainform content" style="background: transparent; box-shadow: 0 !important;" id="regstaf">
             ...
             <div class="mainform content row" style="background: transparent; box-shadow: 0 0 0 ; padding: 0; margin-right: 0 !important; margin-left: 0 !important; margin-bottom: 3em; margin-top: 3em;" id="viewstuds">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin: 0 !important;">
                     ...
                     <div class="alert alert-info hidden-print" style="margin: 1px !important; box-shadow: 0 0 5px;">
                         <div class="row">
                             <div class="col-lg-8 col-md-8 col-sm-12 col-12 hidden-xs hidden-sm"><h3>View Students <span class="fa fa-user"><span class="fa fa-user"></span></h3></div><div class="col-lg-4 col-md-4 col-sm-4 col-6"><button id="filter-btn" class="btn btn-good" style="color:#fff !important; margin-top:20px !important;" id="filter-btn"><i  class="fa fa-filter "></i>Filter Students</button>
            ...
            <div class="row content" id="regstud" style="display: none; margin-top: 3.4em;">
            ...
            <div class="card-body" style="padding: 10px !important;">
                <form method="post" action="regstud.php" id="frmregstud" class="form">
                    ...
                    <!--first row -->
                        ...
                        <input readonly="" id="index" name="index"  style="background-color: #17a2b8; color: #FFF; text-align: center;" type="text" class="form-control input-lg" required="required" placeholder="identification number" />
                      </div>
                    ...
                    <div class="row">
                        ...
                        <!---- third row-->
                         <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                                <label class="control-label" for="dept">Department <span style="color: #F00;" class="fa fa-asterisk"></span></label>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            ...
                                            <div class="md-form">
                                                ...
                                                <input value="<?=date('mm/dd/yyyy')?>" required type="date" name="dor" id="dor" class="form-control">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                                    ...
                                    <select name="ghouse" id="ghouse" class="form-control">
                                        ...
                                        ?>
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                                            <label class="control-label" for="clas">Class <span style="color: #F00;" class="fa fa-asterisk"></span></label>
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                                            <label class="control-label" for="ayear">Academic Year <span style="color: #F00;" class="fa fa-asterisk"></span></label>
                                            <select class="form-control" name="ayear" id="ayear">
                                            </select>
                                        </div>
                                    <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                                        <label class="control-label" for="lschool">Residential Status <span style="color: #F00;" class="fa fa-asterisk"></span></label>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                        <div class="md-form">
                                            ...
                                            <input type="text" name="lsch" required="required"  id="lschool" class="form-control" />
                        ...
                        <br/>
                        <div style="padding: 0;" class="p-2 bg-warning text-white"><p class="text-muted"><h3>Parent/Guidiant's Information <i class="fa fa-caret-down"></i></h3> </p></div>
                        ...
                        <div class="row" style="border-bottom: thin solid #17a2b8">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="md-form">
                                <i class="fa fa-user prefix grey-text"></i>
                                <input class="form-control"  type="text" required="required" name="fthname" id="fthname" />
                                <label  for="fthname">Father's Full Name <span style="color: #F00;" class="fa fa-asterisk"></span></label>
                                </div>

                                        <div class="md-form">
                                            <i class="fa fa-address-book-o prefix grey-text"></i>
                                            <input class="form-control"  type="text" required="required" name="fhtown" id="fhtown" />
                                            <label for="fhtown">Father's Home Town <span style="color: #F00;" class="fa fa-asterisk"></span></label>
                                        </div>
                                        <div class="md-form">
                                            <i class="fa fa-phone prefix grey-text"></i>

                                            <input class="form-control"  type="tel" required="required" name="pthtel" id="pthtel" />
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="card card-default" >
                                    ...
                                    <div class="card-body" style="padding: 5px;">
                                        <div class="md-form">
                                            <i class="fa fa-user prefix grey-text"></i>
                                            <input class="form-control" type="text" required="required" name="mthname" id="mthname" />
                                            <label for="mthname">Mother's Full Name </label>
                                        </div>

                                        <div class="md-form">
                                            <i class="fa fa-address-book-o prefix grey-text"></i>
                                            <input class="form-control" type="text" required="required" name="mtown" id="mtown" />
    ...
    <div class="mainform content row bg-transparent pl-4"  id="viewassess">
        <div class="col-md-12">
						...
						<div class="col-lg-1 col-md-1 col-sm-1 col-4">
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-12 col-8">
                           ...
                           <div class="col-lg-1 col-md-1 col-sm-4 col-6">
                                 <br>
                                 <button title="Reload the content" data-toggle="tooltip" class="btn btn-warning btn-sm" id="reloadbtn5"> Reload <i  class="fa fa-refresh "></i></button>
                             </div>
                         <div class="col-lg-1 col-md-1 sm-4 col-6">
                                 <br>
                                 <button title="Print this assessment" data-toggle="tooltip" class="btn btn-warning btn-sm" id="btnprintassess">Print <i  class="fa fa-print "></i></button>
                         </div>
                            </div>
                     </form>
                     </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-0" style="margin-top: -20px !important;" id="assess-container">
...
<div class="row">
    ...
    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
        <button id="asaddbtn" data-toggle="dropdown" rolw="button" aria-haspopup="true" aria-expanded="false" class="btn btn-good waves-effect waves-button" style="color: #FFFFFF !important;">PRINT <i class="fa fa-caret-down"></i> </button>
        <ul class="dropdown-menu animated zoomIn" aria-labelledby="asaddbtn" >
            <li class="dropdown-item text-muted" style="cursor:pointer;"><a class="text-muted" href="#" onclick="printsubanalysis(); return false;">Subject Base Analysis</a></li>
            <li class="dropdown-item text-muted" style="cursor:pointer;"><a class="text-muted" href="#" onclick="printproganalysis(); return false;">Programme Base Analysis</a></li>
        </ul>
    </div>
</div>
</div>
<div id="waec-content"></div></div>
<div class="mainform content row" style="background: transparent; box-shadow: 0 0 0 ; padding: 0; margin-right: 0 !important; margin-left: 0 !important; margin-bottom: 3em;" id="print-pool">
...
<div class="mainform content row" style="background: transparent; box-shadow: 0 0 0 ; padding: 0;  margin-right: 0 !important; margin-left: 0 !important; margin-bottom: 3em; margin-top: 3em;" id="promtstud">
    <form id="frmpromotstud">
         <div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin: 0 !important;">
                     <div class="alert alert-info" style="margin: 1px !important;">
                         <div class="row">
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
                             ...
                             <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                                 <button onclick="$('#prmfrom_class').change(); return false;" class="btn waves-button">Load</button>
                             </div>
                     </div> 
                    <!--end of from filter-->
                            <div style="border-bottom: 1px solid #ccc; margin: 1px;"></div>
                             <div class="row">
                                 ...
                                 <div style="color:#fff;" class="col-lg-2 col-md-2 col-sm-12 col-12 col-lg-offset-2 col-md-offset-2">
                             ...
                             <div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
                                 ...
                                 <select name="prmto_ayear"  class="form-control" id="prmtoyear">
                                      ...
                                      <div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
                                          ...
                                          <button type="button" onclick="promotstuds();" class="wb wb-good" style="color:#FFFFFF; border-color: #FFFFFF;;">Promote <span class="fa fa-arrow-right"></span></button>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12" id="promt-container"> 
                <center><h3 class="text-muted"><i class="fa fa-filter"></i> Please filter students to promote or click the load button</h3></center>
         </div>
    </form>
    </div>
<div class="mainform content row" style="background: transparent; box-shadow: 0 0 0 ; padding: 0; margin-right: 0 !important; margin-left: 0 !important;" id="print-pool">
</div>
<div class="mainform content row" style="background: transparent; box-shadow: 0 0 0 ; padding: 0; margin-right: 0 !important; margin-left: 0 !important;" id="smsreport">
<div class="row" style="background-color: #17a2b8;">
    ...
    <div class="col-lg-4 col-md-4 col-sm-2 col-xs-2" style="color: #FFFFFF;">
        <br>
        <button onclick="sendSMSreport();" class="btn pull-right waves-effect waves-light" style="background-color: #17a2b8; border:1px solid #FFFFFF;">Send New<i class="fa fa-send-o"></i></button>
    </div>
</div>
    <div id="smsreport-cont"></div>
</div>
<div class="mainform content row" style="background: transparent; box-shadow: 0 0 0 ; padding: 0; margin-right: 0 !important; margin-left: 0 !important;" id="smsnotif">
<div class="row" style="background-color: #17a2b8;">
    <div class="col-lg-8 col-md-8 col-sm-10 col-xs-10" style="color: #FFFFFF;">
        <br>
        <h4><i class="fa fa-info-circle"></i><sup><i class="fa fa-history"></i></sup> SMS Notification History</h4>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-2 col-xs-2" style="color: #FFFFFF;">
        <br>
        <button onclick="sendSMSnotif();" class="btn pull-right waves-effect waves-light" style="background-color: #17a2b8; border:1px solid #FFFFFF;">Send New<i class="fa fa-send-o"></i></button>
    </div>
</div>
    <div id="smsnotif-cont"></div>
</div>
</div>
<!--end of promote students-->
       ...
       // showstart();
        ...
        $(".add-btn").click(function(e){            
            ...
            temp+="<input type ='text' class='form-control'  id='depname' />";
				...
				message:temp,				
				buttons:[{label:"SAVE",cssClass:"bg-info text-white",action:function(d){
          ...
          $.get("saveclass.php?dpid="+$("#dep").val()+"&classname="+$("#classname").val(),null,function(data){
			...
			BootstrapDialog.show({
				...
				message:temp,
				size:"size-wide",
				buttons:[{label:"SAVE",cssClass:"btn bg-info",action:function(d){
...
$(".home-btn").click(function(){
    ...
    closewindow(".content");
        ...
        <button class="btn btn-circle floating-right bg-info waves-effect waves-float waves-light add-btn" style="display: none;"><i class="fa fa-plus"></i></button>
    </body>
</html>
<!-- dialogs ---->
                    ...
                    <div class="search-header">
                        <div class="row">
                            <div class="col-md-1 col-1">
                                <button type="button" class="btn btn-bad btn-sm search-close" > <i class="fa fa-remove fa-4x text-white"></i> </button>
                            </div>
