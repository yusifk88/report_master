...
<div class="row">
    <div class="col-lg-3 col-md-3 col-sm-12 col-12">
        <img src="<?=file_exists($stud->photo)?$stud->photo:'objts/dpic/photo.jpg'?>" alt="<?=$stud->fname?>" class="img-thumbnail img-responsive" width="150" height="180"/> <br>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="md-form">
                    ...
                    <input name="wayear" type="text" readonly id="wayear" class="form-control" value="<?=$stud->ayear?>" />
            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div class="md-form">
                   <i class="prefix fa fa-comments-o"></i>
                    ...
                    <label  class="control-label text-muted" for="wresn">Reason (Why you are withdrawing this student)</label>
                </div>
            </div>
        </div>
        </form>
