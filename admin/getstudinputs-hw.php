            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-info" style="border-radius: 0;">
                        ...
                        <form id="cls-hworkform">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <button onclick="skipstud2(1);" class="btn btn-good waves-effect pull-right">Reset
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-2 co-sm-4 col-xs-4">
                                    <img src="../admin/<?= $row['photo']; ?>" width="180" height="200"
                                         class="img-thumbnail"/>
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 col-md-2">
                                            ...
                                            <input style="text-align: center" id="hw1" class="form-control"
                                                   type="number" value="0"/>
                                        </div>
                                        <div class="col-lg-2 col-md-2">
                                            <label class="control-label">Asign. Two</label>
                                            <input style="text-align: center" id="hw2" class="form-control"
                                                   type="number" value="0"/>
                                        </div>
                                        <div class="col-lg-2 col-md-2">
                                            <label class="control-label">Asign. Three</label>
                                            <input style="text-align: center" id="hw3" class="form-control"
                                                   type="number" value="0"/>
                                        </div>
                                        <div class="col-lg-2 col-md-2">
                                            <label class="control-label">Asign. Four</label>
                                            <input style="text-align: center" id="hw4" class="form-control"
                                                   type="number" value="0"/>
                                        </div>
                                        <div class="col-lg-2 col-md-2">
                                            <label class="control-label">Total</label>
                                            <input style="text-align: center" readonly="" id="hwtotl"
                    ...
                    <div class="panel-footer clsfooter">
                        ...
                        ?>
                        <span class="text-success"> <i class="fa fa-info-circle"></i> <strong>NOTE.</strong> Scores under this category should sum up to a maximum of 30 </span>
...
<script>
    ...
    function savhwork() {
        ...
        if (Number(totl) === 0) {
            $("#hw1").focus();
        } else if (Number(totl) > 30) {
            Snarl.addNotification({
                title: "ERROR",
                text: "Assignment records should sum up to a maximum of 30, please check and try again",
