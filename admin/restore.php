<div class="col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2 col-sm-12 col-xs-12">
    <div class="panel panel-info" style="border-radius: 0;">
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    <div id="rest_zone"
                         style="width: 150px; height: 50px;  margin-left: 10px; border: thin dashed deepskyblue;"></div>
        ...
        <div class="panel-footer">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <button id="run_res" type="button" class="btn btn-good waves-effect waves-button">Run Restore
                    </button>
                </div>
            </div>
        </div>
