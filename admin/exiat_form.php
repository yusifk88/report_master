...
<div class="row">
    <div class="col-md-12 text-muted p-2 mb-2">
        <i class="fa fa-info-circle fa-2x  m-2"></i> A copy of this exeat could be sent to the parent through SMS But it is an on-demand feature and is not available on your package
    </div>
    <div class="col-12 col-md-3">
        <img class="img-responsive" src="<?=file_exists($stinfo->photo)?$stinfo->photo:'objts/dpic/photo.jpg'?>" alt=""> <br/>
    ...
    <div class="col-12 col-md-9">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="md-form">
                    ...
                    <input required class="form-control" type="datetime-local" name="sign_dtime" id="sign_dtime">
            ...
            <div class="col-12 col-md-6">
                <div class="md-form">
                    <i class="prefix fa fa-clock-o active"></i>
                    <input required class="form-control" type="datetime-local" name="return_dtime" id="return_dtime">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="md-form">
                   <textarea required name="reason" id="reason" class="form-control md-textarea" rows="5"></textarea>
        ...
        <table class="table table-sm">
            ...
            <tbody id="exeat_listcont">
                ...
                <tr>
                    ...
                    <td><a href="" class="text-info" onclick="printstf(<?=$exrow->stfid?>); return false"><?=$exrow->fname." ".$exrow->lname?></a></td>
