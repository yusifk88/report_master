...
?>
 <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" style="margin: 0 !important; ">
                        <div class="text-center waves-effect waves-float" id="image_cont" style=" width: 180px; height:200px; color: #FFFFFF; vertical-align: middle; background-position: center; background-size: cover; border: thin dashed deepskyblue; background-image: url('<?= file_exists($row['photo'])?$row['photo']:"objts/dpic/photo.jpg"?>')">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <select name="resstatus" id="resstatus" class="form-control">
                                        <option <?=$row['res_status'] == 'Boarding Student' ? 'selected': ''?> value="Boarding Student">Boarding Student</option>
                                        <option <?=$row['res_status'] == 'Day Student' ? 'selected': ''?> value="Day Student">Day Student</option>
                                    </select>
                            </div>
