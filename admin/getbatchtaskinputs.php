                    ...
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2">
                                ...
                                <input required="required" name="task1[]" autofocus style="text-align: center" id="ta1"
                                       class="form-control taskinput" type="number" value="0"/>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <label class="control-label">Task Two</label>
                                <input required="required" name="task2[]" style="text-align: center" id="ta2"
                                       class="form-control taskinput" type="number" value="0"/>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <label class="control-label">Task Three</label>
                                <input required="required" name="task3[]" style="text-align: center" id="ta3"
                                       class="form-control taskinput" type="number" value="0"/>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <label class="control-label">Task Four</label>
                                <input value="0" required="required" name="task4[]" style="text-align: center" id="ta4"
                                       class="form-control taskinput" type="number"/>
                            </div>
