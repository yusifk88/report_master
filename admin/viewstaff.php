...
if ($_GET['id']){
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <button title="Edit <?=$staff->fname?>'s information " onclick="upstaff(<?= $id ?>)" class="btn btn-link">
                                Edit
                            ...
                            <button title="Print <?=$staff->fname?>'s information " onclick="printstf(<?= $id ?>)" class="btn btn-link">
                                Print
                                <i title="Edit this staff's info"
                            ...
                            <button title="Assign a subject and class to <?=$staff->fname?>" onclick="asub(<?= $id ?>)" class="btn btn-link">
                                Assign Subject
                                <i title="Edit this staff's info"
                            ...
                            <button title="Change <?=$staff->fname?>'s login password" onclick="respass(<?= $id ?>,'<?= $staff->fname ?>')" class="btn btn-link">
                            ...
                            <button title="Delete <?=$staff->fname?>" onclick="delstaff(<?= $id ?>)" class="btn btn-link text-danger">
                                Delete
                                <i title="Edit this staff's info"
        ...
        <div class="col-md-10 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <img width="190" height="200" class="img-thumbnail" src="<?=$staff->photo ? $staff->photo : 'img/photo.jpg'?>">
                    <table class="table">
                        <tr class="w-100">
                            <td>
    ...
    <div class="row">
        <div class="col-md-10 mx-auto">
            ...
            <div class="card">
                <div class="card-header">
                    <p class="card-title">Assigned Classes and Subjects</p>
                </div>
                <div class="card-body">
