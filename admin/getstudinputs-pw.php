...
$cnsql =mysqli_query($cf->con,"select id,fname,lname,oname,photo from stuinfo where class='$cls' and id like '%$stid%' and id  not in (select stid from records  where pw1 is not null and pw2 is not null and acyear = '$ayear' and term = '$term' and subjt = '$subjt' and cls = '$cls' ) and id not in(SELECT stid from withdraw)");
...
$stnames = mysqli_query($cf->con,"select id,fname,lname,oname,photo from stuinfo where class='$cls' and id not in (select stid from records where pw1 is not null and pw2 is not null and acyear = '$ayear' and term = '$term' and subjt = '$subjt' and cls = '$cls') and id not in(SELECT stid from withdraw) order by fname ASC ");
...
<div class="row">
        ...
        <div class="panel panel-info" style="border-radius: 0;">
            <div class="panel-body">
                <form id="cls-hworkform">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <button onclick="skipstud3(1);" class="btn btn-good waves-effect pull-right">Reset <i class="fa fa-undo"></i></button>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <input style="text-align: center" id="pw1" class="form-control" type="number" value="0" />
                         </div>                      
                        <div class="col-lg-4 col-md-4">
                        <label class="control-label">Project W. Two</label>                      
                        <input style="text-align: center" id="pw2" class="form-control" type="number" value="0" />
                         </div>                    
            ...
            <div class="panel-footer clsfooter">
                ...
                if($page>1){?>
                    ...
                    <button id="skipbtn" onclick="skipstud3(<?=$prev?>)" type="button" class="btn btn-good waves-effect waves-button pull-left">&les;&les; Back</button>
                    <?php
                ...
                if($page<$pages){
                    ...
                    <button id="skipbtn2" onclick="skipstud3(<?=$next?>)" type="button" class="btn btn-good waves-effect waves-button pull-right">Skip &GreaterGreater;</button>
   ...
   <?php 
    ...
    ?>
    <h2 class="text-muted"><span class="glyphicon glyphicon-warning-sign"></span>Sorry, no records found, this could be because Project Work records on all students in this class were recorded or no student exist in the selected class </h2>
    <?php
    ...
    function savpwork(){
        ...
        if(Number(totl) ===0){
            ...
            Snarl.addNotification({
                title:"ERROR",
                text:"Class Task records should sum up to a maximum of 20, please check and try again",
