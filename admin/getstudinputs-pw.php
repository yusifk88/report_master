                        ...
                        <form id="cls-hworkform">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <button onclick="skipstud3(1);" class="btn btn-good waves-effect pull-right">Reset
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                            ...
                                            <input style="text-align: center" id="pw1" class="form-control"
                                                   type="number" value="0"/>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <label class="control-label">Project W. Two</label>
                                            <input style="text-align: center" id="pw2" class="form-control"
                                                   type="number" value="0"/>
                                        </div>

                                        <div class="col-lg-4 col-md-4">
                                            <label class="control-label">Total</label>
                                            <input style="text-align: center" readonly="" id="pwtotl"
