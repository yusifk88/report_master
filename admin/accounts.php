...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="alert bg-warning">
        <h4><i class="fa fa-info"></i> If you want to delete a user account, please go to the staff view and delete the staff</h4>
    </div>
                        ...
                        <table class="table table-condensed table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <i onclick="resetpass(<?=$row->id;?>)" title="Reset user's password" style="color: deepskyblue; cursor: pointer;" class="fa fa-refresh waves-effect waves-circle"></i>
                                        
                                    </td>                                    
                                    <td>
                                        <i onclick="disacc(<?=$row->id;?>)" title="Disable user Account" style="color: red; cursor: pointer;" class="fa fa-power-off waves-effect waves-circle"></i>
                                       </td>                                    
                                    ...
                                    <td>
                                        <i onclick="enableacc(<?=$row->id;?>)" title="Enable user Account" style="color: deepskyblue; cursor: pointer;" class="fa fa-star waves-effect waves-circle"></i>
                                       </td>                                    
...
<script type="text/javascript">
    function resetpass(id){
        ...
        $.get("resetpass.php?id="+id,function(data){
			...
			BootstrapDialog.show({
				title:"Reset Account",
				message:data,
				buttons:[{label:"RESET",cssClass:"btn-good waves-button waves-effect",action:function(d){	
  ...
  function disacc(id){
			...
			BootstrapDialog.show({
				...
				buttons:[{label:"DISABLE",cssClass:"btn-bad waves-button waves-effect",action:function(d){	
  ...
  //
   function enableacc(id){
	   	...
	   	BootstrapDialog.show({
				...
				buttons:[{label:"ENABLE",cssClass:"btn-good waves-button waves-effect",action:function(d){	
