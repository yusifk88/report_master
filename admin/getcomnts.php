...
<div class="row">
    <div class="col-lg-2 col-md-2 col-sm-12 col-12 m-0 o-0">
        <img class="img-thumbnail" src="<?=file_exists($stuinfo->photo)? $stuinfo->photo:'objts/dpic/photo.jpg' ?>" alt="<?=$stuinfo->fname?>" width="150" height="180" />
        <br>
    ...
    <div class="md-form">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
            <div class="md-form">
                ...
                <input class="form-control" type="date" name="dentry" id="dentry" required="required"  style="cursor: alias" />
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="md-form">
                <textarea  id="cmnt" class="form-control md-textarea" rows="3" name="cmnt" required="required"></textarea>
