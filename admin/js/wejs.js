...
BootstrapDialog.show({
    ...
    buttons:[{label:"Preview & Print",cssClass:"bg-info",action: function (d) {
...
function allprint() {
    ...
    BootstrapDialog.show({
        ...
        message:temp,
        buttons:[{label:"Preview & Print", cssClass:"btn-good waves-effect waves-button",action:function(){
...
function getclstaks_inputs() {
    ...
    .done(function(data) {
            ...
            BootstrapDialog.show({
                ...
                message: "<div id='task-cont'>" + data + "</div>",
                size: "size-wide",
                closable: false,
                buttons: [{
                    label: "SAVE",
                    cssClass: "btn-good waves-effect waves-button",
                    action: function(d) {
                    ...
                    label: "DONE",
                    cssClass: "btn-bad waves-effect waves-button",
                    action: function(d) {
...
function getbatchclstaks_inputs() {
    ...
    $.get("getbatchtaskinputs.php?cls=" + $("#assess_class").val() + "&ayear=" + $("#assess-ayear").val() + "&term=" + $("#assess-term").val() + "&subjt=" + $("#assess-subjt").val()+"&stid=", function(data) {
        ...
        .done(function(data) {
            remove_fullprog();
            BootstrapDialog.show({
                title: "Enter Batch Class Test Records",
                message: data ,
                size: "size-wide",
                closable: false,
                buttons: [{
...
function getclsassing_inputs() {
    ...
    remove_fullprog();
            BootstrapDialog.show({
                ...
                message: "<div id='hw-cont'>" + data + "</div>",
                size: "size-wide",
                closable: false,
                buttons: [{
                    label: "SAVE",
    ...
    .done(function(data) {
        remove_fullprog();
            BootstrapDialog.show({
                ...
                message: "<div id='pwork-cont'>" + data + "</div>",
                size: "size-wide",
                closable: false,
                buttons: [{
                    label: "SAVE",
...
function getclsexam_inputs() {
    ...
    remove_fullprog();
            BootstrapDialog.show({
                ...
                message: "<div id='exam-cont'>" + data + "</div>",
                size: "size-wide",
                closable: false,
                buttons: [{
                    label: "SAVE",
...
BootstrapDialog.show({
    ...
    message:tmp,
    buttons:[{label:"Mark As Done",cssClass:'bg-info text-white',action: function (d) {
    var cmm = $("#ex-comm").val();
...
function sendSMSnotif(){
            ...
            BootstrapDialog.show({
                ...
                closable:false,
                buttons:[{label:"Cancel",cssClass:"btn-danger",action: function (d) {
                    d.close();
...
function saverecs(form_id) {
    ...
    $.post($(form_id).attr("action"), $(form_id + " :input").serializeArray(), function(data) {}).done(function(data) {
...
function showhelp(){
    BootstrapDialog.show({
        ...
        message: "<blockquote class='blockquote text-muted' style='font-style: italic;'>IF TECHNOLOGY WAS PERFECT, INVENTION WOULD HALT'</blockquote>Incase of anything concerning the system, please contact us on.<br /><strong>Mobile:</strong>+233242044493<br /><strong>E-Mail:</strong>wideempire2016@gmail.com <br/><i>THANK YOU!</i>  "
...
function delhm(id){
    ...
    BootstrapDialog.show({
        ...
        buttons:[{label:"REMOVE",cssClass:"btn-danger",action: function (d) {
...
function addwaec(){
            ...
            BootstrapDialog.show({
                ...
                closable:false,
                buttons:[{label:"SAVE", cssClass:"bg-info",action:function(d){
                    d.close();
                    $("form#frmsavewaec").submit();

                }},
                    {label:"CANCEL",cssClass:"btn-danger",action:function(d){d.close();}}],
                onshown: function () {
...
function printproganalysis(){
    ...
    $.get("waecayear.php",function(data){
        ...
        BootstrapDialog.show({
            ...
            message:data,
            buttons:[{label:"Preview & Print",cssClass:"btn-good waves-effect",action:function(){
                var ayear = $("#waec-ayear").val();
                var prog = $("#anprog").val();
...
buttons:[{label:"RECEIVE",cssClass:"btn-good waves-effect",action:function(d){
...
function addfrm(){
    ...
    $.get("addfrm.php?cls="+$("#frm_class").val()+"&term="+$("#frm-term").val()+"&ayear="+$("#frm-ayear").val(),function(data){
        ...
        BootstrapDialog.show({
            ...
            message:"<div id='frm-cont'>"+data+"</div>",
            closable:false,
            size:"size-wide",
            buttons:[{label:"Save",cssClass:"btn-good waves-effect",action: function (d) {
                savefrm();
            }},{label:"Cancel",cssClass:"btn-bad waves-effect",action: function (d) {
                d.close();
            }}]
...
BootstrapDialog.show({
   title:"Reset Password",
    message:temp,
    buttons:[{label:"Reset",cssClass:'bg-info',action: function () {
...
function addbook(){
    ...
    BootstrapDialog.show({
        ...
        buttons:[{label:"Save",cssClass:"btn-good waves-effect",action: function () {
            var bookinfo = {
              title:$("#bookTitle").val(),
...
BootstrapDialog.show({
    ...
    buttons:[{label:"UPDATE",cssClass:"btn-good waves-effect",action: function (d) {
...
function mklib(id){
    ...
    $.get("mklibfrm.php?id="+id,function(data){
        ...
        BootstrapDialog.show({
            ...
            message:data,
            buttons:[{label:"DONE",cssClass:"bg-info",action:function(d){d.close();}}]
        });
    }).error(function(){
        show_error();
    });
...
function mkform(id){
    ...
    $.get("getfrmmst.php?id="+id,function(data){
        ...
        BootstrapDialog.show({
            ...
            message:data,
            buttons:[{label:"DONE",cssClass:"btn bg-info",action:function(d){d.close();}}]
        });
    }).error(function(){
        show_error();
    });
...
function upstaff(id){
    ...
    $.get("get_up_inputs.php?id="+id,null,function(data){
        ...
        BootstrapDialog.show({
            ...
            message:data,
            buttons:[{label:"UPDATE",cssClass:"btn bg-info",action:function(d){
...
function rmsub(sfid,id){
    BootstrapDialog.show({
        ...
        type:'danger',
        buttons:[{label:"REMOVE",cssClass:"btn btn-danger",action:function(d){
            d.close();
            fullProg();
...
function asub(id){
    ...
    $.get("subcls.php",null,function(data){
        ...
        BootstrapDialog.show({
            ...
            message:data,
            buttons:[{label:"ASSIGN",cssClass:"btn bg-info",action:function(d){
                d.close();
...
BootstrapDialog.show({
    ...
    buttons:[{label:"RESET", cssClass:"btn-bad",action:function(d){
        fullProg();
...
function printrep(id){
    ...
    buttons:[{label:"VIEW & PRINT",cssClass:"bg-info",action:function (d) {
...
function unwithdraw(id){
    BootstrapDialog.show({
        ...
        buttons:[{label:"RESUME",cssClass:"bg-info",action:function(d){
            d.close();
            fullProg();
...
function exiat(id){
        BootstrapDialog.show({
            ...
            buttons:[{label:"CLOSE",cssClass:"btn-danger",action: function (d) {
                d.close();
            }}]
        });
}
...
function withdraw(id){
        ...
        BootstrapDialog.show({
            ...
            buttons:[{label:"WITHDRAW",cssClass:"btn-danger",action:function(d){
                if(!$("#wresn").val()){
                    $("#wresn").focus();
                }else if(!$("#wdate").val()){
                    $("#wdate").focus();
...
function upstud(id,row){
        BootstrapDialog.show({
            ...
            size:"size-wide",
            closable:false,
            buttons:[{label:"UPDATE",cssClass:"bg-info",action:function(d){
                if(!$("#upfname").val()){
                    Snarl.addNotification({
                        title:"MISSING INPUT",
