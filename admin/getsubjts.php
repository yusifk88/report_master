...
<div class="table-responsive text-nowrap">
        ...
        <tbody>
            ...
            <tr id="row_<?=$row['id']?>">
                ...
                <td><i class="fa fa-edit waves-effect waves-circle editicon2" title="Edit this Subject" data-type="<?php echo"$row[type]";  ?>" data-input="<?php echo "$row[subjdesc]";?>" data-id="<?php echo $row['id']; ?>" style="color: deepskyblue; cursor: pointer;"></i></td>
                <td><i class="fa fa-remove waves-effect waves-circle delicon2" title="Delete this Subject" data-del="delsubj.php" data-id="<?php echo $row['id']; ?>" style="color: #F00; cursor: pointer;"></i></td>
...
<?php
    ...
    ?>
<p style="margin-top:10em;"><h1 class="text-danger">No subjects registered at the moment <span class="glyphicon glyphicon-warning-sign"</h1>
