                    ...
                    while($row = mysqli_fetch_object($staff_list)){
                     ?>
                        <tr>
                            ...
                            <td style="vertical-align: middle"> <a href="" onclick='printstf(<?=$row->stfid?>); return false'><?=$row->fname?> <?=$row->lname?><a/> </td>
                            <td style="vertical-align: middle"><?=$row->classname?></td>
                            <td style="vertical-align: middle"><?=$row->subjdesc?></td>
                            <td class="text-center" style="vertical-align: middle"><?=$row->entry_pop?> Out Of <?=$row->class_pop?></td>
                            <td class="text-center" style="vertical-align: middle"><?=$row->class_pop<1?"-":number_format(($row->entry_pop/$row->class_pop)*100,1)?>%</td>
                            <td>
