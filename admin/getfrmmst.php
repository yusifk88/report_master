        ...
        <form action="addfrm.php" id="addfrm">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <input class="form-control" readonly type="text" value="<?=$stinfo->fname." ".$stinfo->lname?>" >
                </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <select name="cls" id="cls" class="form-control">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <button onclick="mkfrm()" id="btnaddfrm" type="button" class="btn bg-info">Add <i class="fa fa-plus-square-o"></i> </button>
                </div>
            </div>
        </form>
    </div>
...
<?php
    while($row2 = mysqli_fetch_object($stfclasses)){
        ...
        <tr id="frm_row<?=$row2->id?>">
            ...
            <td><i  onclick="remfrmm(<?=$row2->id;?>)" style="cursor: pointer;" data-toggle="tooltip" title="Remove" class="fa fa-remove text-danger waves-effect waves-circle"></i></td>
        </tr>
        <?php
    }
?>
