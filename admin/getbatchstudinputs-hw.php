                    ...
                    <div class="alert alert-info">
                        <ul>
                            ...
                            <li class="bg-warning text-dark">
                                Records under this category MUST aum up to a maximum of 40
                            </li>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2">
                                ...
                                <input name="hw1[]" style="text-align: center" id="hw1" class="form-control"
                                       type="number" value="0"/>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <label class="control-label">Asign. Two</label>
                                <input name="hw2[]" style="text-align: center" id="hw2" class="form-control"
                                       type="number" value="0"/>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <label class="control-label">Asign. Three</label>
                                <input name="hw3[]" style="text-align: center" id="hw3" class="form-control"
                                       type="number" value="0"/>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <label class="control-label">Asign. Four</label>
                                <input name="hw4[]" style="text-align: center" id="hw4" class="form-control"
                                       type="number" value="0"/>
                            </div>
                        </div>
                    </div>
