...
<div class="table-responsive text-nowrap">
        ...
        <tbody>
            ...
            <tr id="row_<?=$row['id']?>">
                ...
                <td><i class="fa fa-edit waves-effect waves-button editicon3" title="Edit this department" data-input="<?php echo "$row[name]";?>" data-id="<?php echo $row['id']; ?>" data-des="<?=$row['des'];?>" data-htype="<?=$row['house_type']?>" style="color: deepskyblue; cursor: pointer;"></i></td>
                <td><i class="fa fa-remove  waves-effect waves-button delicon3" title="Delete this department" data-del="delhouse.php" data-id="<?php echo $row['id']; ?>" style="color: #F00; cursor: pointer;"></i></td>
            </tr>
                <?php
                $i++;
                }
...
<?php
    ...
    ?>
<p><h1 class="text-danger" style="text-align: center; margin-top: 5em;">No houses registered at the moment <span class="glyphicon glyphicon-warning-sign"></span></h1></p>
    <?php
}
