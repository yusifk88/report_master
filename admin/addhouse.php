...
$myhouse = mysqli_query($cf->con,"select houses.name,housem.id from houses,housem where houses.id in(SELECT hid from housem where stfid = '$stfid')  and  houses.id = housem.hid");
?>
                              ...
                              <div class="list-group-item">
                                  <div class="row">
                                      ...
                                      <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                          <i onclick="delhm(<?=$h->id?>)" class="fa fa-remove text-danger pull-right waves-effect waves-circle"></i>
                                      </div>
                                  </div>
                              </div>
                          </div>
