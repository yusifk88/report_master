...
<div class="table-responsive">
    ...
    <table class="table table-striped table-hover">
        ...
        <td><i title="Edit this class" data-get="<?= $row['classname'];?>" data-dpid="<?= $row['dpid'];?>"style="color: deepskyblue; cursor: pointer;" class="fa fa-edit editicon1" data-id="<?php echo $row['id'];?>"> </i></td>
        <td><i title="Delete this class" style="color: red; cursor: pointer;" class="fa fa-remove waves-effect waves-circle delicon" data-id="<?= $row['id'];?>"> </i></td>
            </tr>
                <?php
                $i++;
            }
