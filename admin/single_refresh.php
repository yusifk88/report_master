      ...
      <div class="card border-success ">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="imgcont_<?=$row->stindex?>">
                        <img  alt="<?= $row->fname?>"
                            src ='<?= file_exists($row->photo) ? $row->photo : 'objts/dpic/photo.jpg' ?>' class="img-thumbnail img-fluid img-responsive st-photos"/>
                     </div>
                    <div class="col-lg-10 col-md-10 col-sm-10 col-10"
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-sm"
                                ...
                                <tr>
                                    <th class="th-sm"><?= $row->name;?> <br> <small class="text-muted">House</small></th>
                                    <th class="th-sm"><?= $row->lschool; ?> <br> <small class="text-muted">Last Sch.</small> </th>
                                    <th class="th-sm"><?= $row->dor; ?><br> <small class="text-muted">Reg Date</small></th>
