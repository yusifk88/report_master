...
?>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-3 text-center" style="border-right: 1px solid #CCCCCC; height: 100%;">
                    <?=$ayear?>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 col-3 text-center" style="border-right: 1px solid #CCCCCC; vertical-align: middle;">
