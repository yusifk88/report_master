    ...
    while ($row1 = mysqli_fetch_object($stids)) {
        ...
        <div class="row" style="border-bottom: solid 1px #000; margin-bottom: 10px;">
            ...
            <div class="col-lg-10 col-md-10">
                <center>
                    ...
                    <strong>Tel:</strong> <?= $stinfo->ftel; ?><?= $stinfo->mtel ? "/" . $stinfo->mtel : "" ?>
        ...
        <div style="background-image: url('./img/wmark2.png'); background-repeat: no-repeat !important; background-position: center !important; background-size: cover !important;">
            ...
            <table class="table table-striped" style=" font-size: 12px;">
                ...
                <tbody>
                <tr>
                    <td colspan="7" style="text-align: center; font-weight: bold; font-style: italic;"><h4>CORE
                            SUBJECTS</h4></td>
                </tr>
                <?php
                ...
                <tr>
                    <td colspan="7" style="text-align: center; font-weight: bold; font-style: italic;"><h4>ELECTIVE
                            SUBJECTS</h4></td>
                </tr>
        ...
        <div class="row" style="border-top: 1px solid #000; padding-top: 5px;">
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="padding-left: 10px;">
                ...
                if (mysqli_num_rows($frmrces) < 1) {
                    ...
                    <div class='row' style="font-size: 12px;">
                        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                            <p><strong>ATTENDANCE:</strong> <?= $frmrow->attnded; ?> OUT OF <?= $frmrow->attdance; ?>
                            </p>
                        </div>
                    </div>
                    <div class='row' style="font-size: 12px;">
                    ...
                    while ($c = mysqli_fetch_object($cmnt)) {
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <strong>
                                    On <?= $c->dentry ?>, <?= $c->ayear ?> Academic
                                    Year, <?= $util->addsufix($c->term) ?> Term
                                </strong><br>
                                <?= $c->coment; ?>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <table CLASS="table table-condensed pull-right"
                       style="font-size: 10px; width: 200px; height: 30px; text-align: center">
                    <thead>
                    <tr>
                        <td colspan="3">
