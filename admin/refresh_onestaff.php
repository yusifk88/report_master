    ...
    <div class="card hoverable" style="margin: 0 !important;">
        <div class="card-body p-0 ">
            <div class="table-responsive">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 sub-info <?php echo "sub-inf-" . $d->id; ?>"
                     style="display: none;">
                    <?php
                    $id = $d->id;
        ...
        <div class="card-footer p-1">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <i title="Edit this staff's info" onclick="upstaff(<?= $id ?>)" data-id="<?php echo $id; ?>"
                       class="fa fa-edit waves-effect waves-circle editicon4"
                       style="color: deepskyblue; cursor: pointer;"></i>
                    <i title="Print staff profile" onclick="printstf(<?= $id ?>)"
                       class="fa fa-print waves-effect waves-circle " style="color: deepskyblue; cursor: pointer;"></i>
                    <i class="fa fa-book waves-effect waves-circle asub" onclick="asub(<?= $id ?>)"
                       title="Assign subjects to this staff" style="color: deepskyblue; cursor: pointer;"><sup><i
                    ...
                    <i id="exduties" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                       ...
                       title="Assing some extra duties to this staff"></i>
                    <ul class="dropdown-menu animated fadeInUp" aria-labelledby="exduties">
                        <li class="dropdown-item text-muted" style="cursor:pointer;"><a onclick="mkform(<?= $id; ?>)">Form <?= $gender == 'Male' ? 'Master' : 'Mistress' ?></a>
                        </li>
                        ...
                        <li class="dropdown-item text-muted" style="cursor:pointer;"><a onclick="addshm(<?= $id ?>)">Senior
                                House <?= ($gender == 'Male') ? 'Master' : 'Mistress' ?> </a></li>
                        <li class="dropdown-item text-muted" style="cursor:pointer;"><a onclick="mkwo(<?= $id ?>)">WAEC/Exam
                                Officer</a></li>
                        <li class="dropdown-item text-muted" style="cursor:pointer;"><a onclick="mklib(<?= $id ?>)">Librarian</a>
                        </li>
                    </ul>
                    <i class="fa fa-repeat waves-effect waves-circle" title="Reset Password"
                       onclick="respass(<?= $id ?>,'<?= $fname ?>')" style="color:red; cursor: pointer;"></i>
                    ...
                    <i data-show="<?php echo(".sub-inf-" . $id); ?>" onclick="show_sub(<?= $id ?>)"
