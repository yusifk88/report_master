...
.rescont{
    background-image:  url('./img/wmark3.png') !important; background-repeat: no-repeat; background-position: center; background-size: contain;
   background-repeat: no-repeat !important; background-position: center !important; background-size: 60% !important; 
    ...
    <body>
        ...
        ?>
           <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                     <center>
                          <img style="margin: 10px;" class="img-responsive" src="objts/<?= $sch->logopath ?>" alt="School Crest" /> <br/>
            ...
            <div class="row" style="page-break-after: always;">
                ...
                <tr>
                    ...
                    <th rowspan="5" style="text-align: center;">
                        <img width="180" height="200" src="<?=$stinfo->photo;?>" />
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle;"><?="FORM ".$stinfo->form;?></td>
                     ...
                     <center> <span style="font-style: italic;" class="text-danger  hidden-print" >(THIS DOCUMENT SHOULD BE ENDORSED BY THE HEADMASTER/MISTRESS OF THE SCHOOL )</span></center>
                <br/>
                 </div>
            </div>         
        ...
        $term = 1;
          ?>
          <div class="rescont" style="background-image:  url('./img/wmark3.png') !important; background-repeat: no-repeat; background-position: center;  background-color: transparent !important; border: 1px solid #000; margin-bottom: 5px; padding:5px; page-break-after: always;">
        ...
        ?>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <table class="table table-striped table-condensed" style=" font-size: 12px; background-color: transparent !important; background-image: background-repeat: no-repeat; background-size:corver; background-position:center;">
            <thead> 
                <tr>
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="5" class="text-muted" style="text-align: center; font-weight: bold; font-style: italic;">CORE SUBJECTS</td>
        ...
        ?> 
                 ...
                 <tr>
                     ...
                     <td class="text-muted" colspan="5" style="text-align: center; font-weight: bold; font-style: italic;">ELECTIVE SUBJECTS</td>
      ...
      ?>
            ...
            <div class="row hidden-print">
                <div style="border: 1px dashed red" class="col-lg-12 col-md-12 col-xs-12 alert alert-info">
                    Individual subjet averages are caculated by adding all total scores for each subject in a year and then dividing the sum by 3 (3 terms) <br>
                    Total averages are caculated by adding all individual averages of each subject and then dividing the sum by 7 (7 terms) <br>
                    7 terms because final year students don't get to complete their eighth and ninth term so they end up doing 7 terms with assessment in three years <br>

                    <strong>Please note that if the government ever change the number of years a student should do in senior high school, you are supposed to call for an update as this function can only be adjusted through code</strong>
                </div>
            </div>
            <div class="row">
            <div class="col-lg-12 col-md-12">
                <center><p><h3><u>Accumulated Averages</u></h3></p></center>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            $ys2 = mysqli_query($cf->con,"select distinct(acyear) from records WHERE stid = '$stid' ORDER by acyear ASC ");
                               $sumt = 0;
                                while($y2 = mysqli_fetch_object($ys2)){
                                    $sums = mysqli_fetch_object(mysqli_query($cf->con,"select sum(totlscore) as sm from records WHERE stid = '$stid' and acyear = '$y2->acyear' and subjt = '$sids->subjt'"))->sm;
                                    $sumt+= $sums;
                                ?>
                                    <td style="text-align: center;"><?=  number_format(($sums/3),2)?></td>
                                <?php
                                }
                           // $tsums = mysqli_fetch_object(mysqli_query($cf->con,"select sum(totlscore) as sm from records where stid = '$stid' and subjt = '$sids->subjt'"))->sm;
                            ?>
                            <td style="text-align: center;"><?=number_format(($sumt/7),2)?></td>
                            <?php
                            ?>
                        </tr>
                        <?php
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <strong>  HEADMASTER/HEADMISTRESS' SIGNATURE/STAMP................................................................</strong>
