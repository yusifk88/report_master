...
<!--                            <td style="text-align: center; vertical-align: middle;"></td>-->
                            ...
                            <td style="text-align: center; vertical-align: middle;"><i data-toggle='tooltip' onclick="updateassess(<?=$recrow['id']?>)" title="Make changes to this record" style="color: deepskyblue; cursor: pointer;" class="fa fa-edit waves-effect waves-circle"></i></td>
                            <td style="text-align: center; vertical-align: middle;"><i data-toggle='tooltip' onclick="delass(<?=$recrow['id']?>)" title="Delete this record permanently" style="color: red; cursor: pointer;" class="fa fa-remove waves-effect waves-circle"></i></td>
                        </tr>
                        <?php
                        $a++;
                    }
