...
<div class="row">
    ...
    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" style="margin: 0 !important; ">
        <div class="text-center waves-effect waves-float" id="image_cont"
             style=" width: 180px; height:200px; color: #FFFFFF; vertical-align: middle; background-position: center; background-size: cover; border: thin dashed deepskyblue; background-image: url('<?= file_exists('../admin/'.$row['photo']) ? $row['photo'] : "../admin/objts/dpic/photo.jpg" ?>')">
