                                ...
                                <table class="table table-condensed table-hover table-striped">
                                    ...
                                    while ($row = mysql_fetch_assoc($data)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="glyphicon glyphicon-remove rmsub"
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <span title="Edit this staff's info" data-id="<?php echo $id; ?>"
                                      class="glyphicon glyphicon-edit editicon4"
                                      style="color: deepskyblue; cursor: pointer;"></span>
                                <span class="glyphicon glyphicon-book asub" data-id="<?php echo $id; ?>"
                                      title="Assign subjects to this staff"
                                      style="color: deepskyblue; cursor: pointer;"><sup><span
                                                class="glyphicon glyphicon-plus"></span></sup></span>
                                <span class="glyphicon glyphicon-trash delstaff" title="Delete this staff"
                                      data-id="<?php echo $id; ?>" style="color:red; cursor: pointer;"></span>
                                <span data-show="<?php echo(".sub-inf-" . $id); ?>"
                                      class="glyphicon glyphicon-list pull-right sub-show"
                                      title="View details about this staff"
                                      style="color: deepskyblue; cursor: pointer;"><sub><span
                                                class="glyphicon glyphicon-arrow-down"></span></sub></span>
                            </div>
