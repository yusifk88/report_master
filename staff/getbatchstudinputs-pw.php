                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                            ...
                                            <input min="1" max="20" name="pw1[]" maxlength="2" style="text-align: center" id="pw1" class="form-control" type="number" value="0" />
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <label class="control-label">Project W. Two</label>
                                            <input min="1" max="20" name="pw2[]" maxlength="2" style="text-align: center" id="pw2" class="form-control" type="number" value="0" />
                                        </div>
