                    ...
                    <div class="col-md-10 col-10">
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6">
                                <div class="md-form">
                                <input min="0" max="20" name="pw1[]" maxlength="2" style="text-align: center" id="pw1" class="form-control" type="number" value="0"/>
                                    <label for="pw1" class="control-label active">Project W. One</label>
                                </div>
                                </div>
                            <div class="col-6 col-md-6">
                                <div class="md-form">
                                    <input min="0" max="20" name="pw2[]" maxlength="2" style="text-align: center" id="pw2" class="form-control" type="number" value="0"/>
