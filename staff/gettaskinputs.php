        ...
        <div class="panel panel-info" style="border-radius: 0;">
            <div class="panel-body">
                <form id="cls-taskform">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <button onclick="skipstud(1);" class="btn btn-good waves-effect pull-right">Reset <i class="fa fa-undo"></i></button>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <label class="control-label">Test One</label>
                        <input autofocus style="text-align: center" id="ta1" class="form-control" type="number" value="0" />
                         </div>                      
                        <div class="col-lg-2 col-md-2">
                        <label class="control-label">Test Two</label>
                        <input style="text-align: center" id="ta2" class="form-control" type="number" value="0" />
                         </div>                      
                        <div class="col-lg-2 col-md-2">
                        <label class="control-label">Test Three</label>
                        <input style="text-align: center" id="ta3" class="form-control" type="number" value="0" />
                         </div>                      
                        <div class="col-lg-2 col-md-2">
                        <label class="control-label">Test Four</label>
                        <input style="text-align: center" id="ta4" class="form-control" type="number" value="0" />
                         </div>  
            ...
            <div class="panel-footer clsfooter">
                ...
                if($page>1){?>
                    ...
                    <button id="skipbtn" onclick="skipstud(<?=$prev?>)" type="button" class="btn btn-good waves-effect waves-button pull-left">&les;&les; Back</button>
              <?php
                }
                ?>
              ...
              // echo 'term:'. $term."year:".$ayear."sub:".$subjt."cls:".$cls;
               ...
               ?>
                ...
                <button id="skipbtn" onclick="skipstud(<?=$next?>)" type="button" class="btn btn-good waves-effect waves-button pull-right">Skip &GreaterGreater;</button>
