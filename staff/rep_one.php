...
<head>
    ...
    <style type="text/css">
        ...
        @media print {
            ...
            table.table-striped {
                background-image: url('../admin/img/wmark2.png') !important;
    ...
    <table class="table table-striped table-condensed"
        ...
        <tr>
            <th rowspan="2" style="text-align: center;">
                <img width="120" height="140" src="<?=file_exists('../admin/'.$stinfo->photo) ? '../admin/'.$stinfo->photo : '../admin/objts/dpic/photo.jpg' ?>"/>
            </th>
