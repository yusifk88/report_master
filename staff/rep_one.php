...
table.table-striped{
    background-image:  url('../admin/img/wmark2.png') !important; background-repeat: no-repeat; background-position: center; background-size: contain;
   background-repeat: no-repeat !important; background-position: center !important; background-size: 50% !important; 
    ...
    <body>
       ...
       $myclas = mysqli_fetch_object(mysqli_query($cf->con,"select * from classes where id ='$cls'"));
        ...
        <strong>Community:</strong> <?=$stinfo->fhometown;?>, <stronng>Tel:</stronng> <?=$stinfo->ftel;?><?=$stinfo->mtel ?"/".$stinfo->mtel:""?>,
         <strong>House:</strong> <?=$stinfo->name;?>
            ...
            <thead>
                <tr>
                    ...
                    <img width="120" height="140" src="../admin/<?=$stinfo->photo;?>" />
                    </th>
