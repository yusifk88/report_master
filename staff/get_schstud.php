                ...
                <div class="panel-body" style="padding: 0 !important; margin: 0 !important;">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-3"
                            ...
                            <img style="max-height: 170px; border-radius: 0 !important; "
...
<script>
        ...
        $.get("print_rep_one.php?stid=" + id, function (data) {
            BootstrapDialog.show({
                ...
                message: data, buttons: [{
                    label: "VIEW & PRINT", cssClass: "btn-good waves-effect waves-button", action: function (d) {
    ...
    function unwithdraw(id) {
        ...
        BootstrapDialog.show({
            ...
            buttons: [{
                label: "RESUME", cssClass: "btn-good waves-effect waves-button", action: function (d) {
                    d.close();
    ...
    function withdraw(id) {
        ...
        $.get("wfrm.php?id=" + id, function (data) {
            ...
            BootstrapDialog.show({
                ...
                message: data,
                buttons: [{
                    label: "WITHDRAW", cssClass: "btn-bad waves-effect waves-button", action: function (d) {
                        if (!$("#wresn").val()) {
                            $("#wresn").focus();
                        } else if (!$("#wdate").val()) {
                            $("#wdate").focus();
    ...
    function Comnt(id) {
        ...
        $.get("getcomnts.php?id=" + id, function (data) {
            ...
            BootstrapDialog.show({
                ...
                closable: false,
                buttons: [{
                    label: "DONE", cssClass: "btn-good waves-effect waves-button", action: function (d) {
                        d.close();
                    }
                }]
