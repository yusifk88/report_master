        ...
        <div class="card hoverable <?= $wtest ? 'border-danger' : '' ?> ">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="imgcont_<?= $row['stindex'] ?>">
                    <img alt="<?= $row['fname'] ?>"
                         datasrc="<?= file_exists('../admin/'.$row['photo']) ? '../admin/'.$row['photo'] : 'objts/dpic/photo.jpg' ?>"
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-10"
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-sm"
                            ...
                            <tr>
                                <th class="th-sm"><?php echo $row['name']; ?> <br>
                                    <small class="text-muted">House</small>
                                </th>
                                <th class="th-sm"><?php echo $row['lschool']; ?> <br>
                                    <small class="text-muted">Last Sch.</small>
                                </th>
                                <th class="th-sm"><?php echo $row['dor']; ?><br>
...
<div class="col-md-4 col-12 mx-auto text-center">
    ...
    if (($page < $pages)) {
        ?>
        <br/>
        <a style="cursor:pointer;" class="btn bg-info text-white btn-sm" onclick="getstud(<?php echo $next; ?>)">Next
            &GreaterGreater;</a>
        <a style="cursor:pointer;" class="btn bg-info text-white btn-sm" onclick="getstud(<?php echo $pages; ?>)">Last
            Page</a>
        <?php
    }
