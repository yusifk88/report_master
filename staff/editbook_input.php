...
<form id="editbookfrm">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <input placeholder="Enter book title" class="form-control" value="<?= $binfo->title ?>" id="upbookTitle"
                   name="upbookTitle" required="" type="text">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <label class="control-label">Author(s)</label>
            <input placeholder="Enter name(s) of author(s) of the book" value="<?= $binfo->author ?>"
                   class="form-control" id="upbookAuthor" name="upbookAuthor" required="" type="text">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <label class="control-label">ISBN Number</label>
            <input class="form-control" id="bookISBN" value="<?= $binfo->isbn ?>" name="upbookISBN" required=""
                   type="text">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <label class="control-label">Shelf/Location</label>
            <input placeholder="describe the shelf in which the book can be found" value="<?= $binfo->shelf ?>"
                   class="form-control" id="upbookShelf" name="upbookShelf" required="" type="text">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <label class="control-label">Number Of Copies</label>
            <input min="1" value="<?= $binfo->copies ?>" placeholder="Enter the number of copies of this book"
                   class="form-control" id="upbookQty" name="upbookQty" required="" type="number">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <label class="control-label">Custom Description</label>
            <textarea name="upbookDesc" id="bookDesc" class="form-control"
                      placeholder="Describe the book in your own words"><?= $binfo->descrip ?></textarea>
        </div>
    </div>
</form>
<script>
