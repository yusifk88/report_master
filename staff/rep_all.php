    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td style="vertical-align: middle;"
                colspan="3"><?= $stinfo->fname . ' ' . $stinfo->lname . ' ' . $stinfo->oname ?></td>
        ...
        <tr>
            ...
            <td class="text-muted" colspan="7" style="text-align: center; font-weight: bold; font-style: italic;">CORE
                SUBJECTS
            </td>
        ...
        <tr>
            ...
            <td class="text-muted" colspan="7" style="text-align: center; font-weight: bold; font-style: italic;">
                ELECTIVE SUBJECTS
            </td>
