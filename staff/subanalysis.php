        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <table class="table table-striped table-condensed text-center table-hover">
                ...
                while($testrow = mysqli_fetch_object($testud)){
                    $stid = $testrow->id;
                    $cnt = mysqli_fetch_object(mysqli_query($cf->con,"select count(*) as cn from waec where grade_val <=8 and stid='$stid' "))->cn;
                    if($cnt == 8){
                        $p8++;
                    }else if($cnt == 7){
                        $p7++;
                ...
                while($testrow1 = mysqli_fetch_object($testud1)){
                    $stid1 = $testrow1->id;
                    $cnt1 = mysqli_fetch_object(mysqli_query($cf->con,"select count(*) as cn from waec where grade_val <=8 and stid='$stid1' "))->cn;
                    if($cnt1 == 8){
                        $pg8++;
                    }else if($cnt1 == 7){
                        $pg7++;
                ...
                <tr>
                    <th class="text-center" style="vertical-align: middle;">No. and percentage of candidates with aggregates between 6 and 24</th>
                    <td><?=best_range()?></td>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <table class="table table-condensed table-striped">
                ...
                <tr>
                    ...
                    <td><?=$pg2?></td>
                    <td><?=$pg2+$p2?></td>
                    <td><?=number_format((($pg2+$p2)/$allcan)*100,2)?>%</td>
                </tr>
                <tr>
                    <td>1 PASS</td>
                    <td><?=$p1?></td>
                ...
                <tr class="text-danger">
                    ...
                    <th><?=number_format((($absent+$absent1)/$rawtotls)*100,1)?>% OF TOTAL NUMBER <br> OF CANDIDATES(<?=$rawtotls?>)</th>
                </tr>
