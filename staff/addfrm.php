            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-info" style="border-radius: 0; box-shadow: none; margin: 0 !important;">
                    <div class="panel-body"  style="padding: 0 !important; margin: 0 !important;">
                        <form id="frmaddfrm">
                            ...
                            <div class="row">
                                ...
                                <img src="../admin/<?= $row['photo'];?>" width="150" height="180" class="img-thumbnail" /><br>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            ...
                                            <input id="attndance" value="<?=$svattendance?>" required class="form-control" type="number" name="attndance" />
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <label class="control-label">Total Attended</label>
                                            <input id="attnded" required class="form-control" type="number" name="attnded" />
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <label class="control-label">Conduct</label>
                                            <textarea required class="form-control" name="cnduct" id="cnduct" rows="1"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <label class="control-label">Interest</label>
                                            <textarea required name="interest" class="form-control" id="interest" rows="1"></textarea>
                                        </div>
                                         <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <label class="control-label">Your Remark</label>
                                            <textarea required name="remark" class="form-control" id="remark" rows="1"></textarea>
                                        </div>
                                    </div>
                                    </div>
                    ...
                    <div class="panel-footer">
                        ...
                        if(($pages-$page)>-1){
                            ?>
                            <button id="frmskipbtn" onclick="frmskipstud(<?=$page?>)" type="button" class="btn btn-good pull-right waves-effect waves-button">Skip &GreaterGreater;</button>
