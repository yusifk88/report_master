...
border:1px solid #000 !important;
    ...
    <body>
        ...
        $cfg = new config();
        $cfg->connect();
        $cls_list = mysqli_query("select fname,oname,lname,stindex,gender from stuinfo where class = '$cls' and ayear = '$ayear' order by fname ASC ");
        $sch = new school();
        ...
        ?>
            ...
            <div class="row">
                ...
                <span style="font-size: 25px;">LIST OF STUDENTS IN <?= strtoupper($cl);?> </span>
