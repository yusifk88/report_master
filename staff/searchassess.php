...
<div class="table-responsive">
    ...
    <?php
        ...
        <tr>
            ...
            <td><span data-toggle='tooltip' onclick="updateassess(<?=$recrow['id'];?>)" title="Make changes to this record" style="color: deepskyblue; cursor: pointer;" class="glyphicon glyphicon-edit"></span></td>
            <td><span data-toggle='tooltip' onclick="delass(<?=$recrow['id'];?>)" title="Delete this record permanently" style="color: red; cursor: pointer;" class="glyphicon glyphicon-trash"></span></td>
