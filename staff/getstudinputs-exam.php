                        ...
                        <form id="cls-examform">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <button onclick="skipstud4(1);" class="btn rgba-cyan-strong btn-sm pull-right">Reset
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                            <div class="md-form">
                                                <input autofocus min="0" max="100" maxlength="3" style="text-align: center" id="exam_val" class="form-control" type="number" value="0"/>
