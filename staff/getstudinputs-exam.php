...
$stnames = mysqli_query($cf->con,"select id,fname,lname,oname,photo from stuinfo where class='$cls' and ayear = '$ayear' and id not in (select stid from records where exam >0 and acyear = '$ayear' and term = '$term' and subjt = '$subjt' and cls = '$cls') and id not in(SELECT stid from withdraw) order by fname ASC");
...
<div class="row">
        ...
        <div class="panel panel-info" style="border-radius: 0;">
            <div class="panel-body">
                <form id="cls-examform">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <button onclick="skipstud4(1);" class="btn btn-good waves-effect pull-right">Reset <i class="fa fa-undo"></i></button>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <input autofocus maxlength="3" style="text-align: center" id="exam_val" class="form-control" type="number" value="0" />
                         </div>                      
                          </div>
                   </div>
                    </div>
            ...
            <div class="panel-footer clsfooter">
                ...
                if($page>1){?>
                    ...
                    <button id="skipbtn" onclick="skipstud4(<?=$prev?>)" type="button" class="btn btn-good waves-effect waves-button pull-left">&les;&les; Back</button>
                    <?php
                ...
                if($page<$pages){
                    ...
                    <button id="skipbtn2" onclick="skipstud4(<?=$next?>)" type="button" class="btn btn-good waves-effect waves-button pull-right">Skip &GreaterGreater;</button>
   ...
   <?php 
    ...
    ?>
    <h2 class="text-muted"><span class="glyphicon glyphicon-warning-sign"></span>Sorry, no records found, this could be because Exam records on all students in this class were recorded or no student exist in the selected class </h2>
    <?php
