        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <table class="table table-condensed table-striped table-hover">
                ...
                <tr class="hidden-print">
                    ...
                    <th id="colg10" ><button onclick="rmcol('colg10');" class="btn btn-xs btn-danger">X</button></th>
                ...
                if(count($studs)>0){
                    ...
                    while($stud=mysqli_fetch_object($studs)){
                        ...
                        <tr>
                            ...
                            <td id="col2"><center><img src="../admin/<?=$stud->photo?>"  width="90" hieght="100"/></center></td>
                            ...
                            <td id="colg10" style="text-align: center;" ><?=$stud->ghouse?$stud->ghouse:"None"?></td>
