        ...
        <table class="table table-condensed table-striped table-hover">
            ...
            while ($row = mysql_fetch_assoc($d)) {
                ...
                <tr>
                    ...
                    <td><span title="Edit this class" data-get="<?php echo $row['classname']; ?>"
                              data-dpid="<?php echo $row['dpid']; ?>" style="color: deepskyblue; cursor: pointer;"
                              class="glyphicon glyphicon-edit editicon1" data-id="<?php echo $row['id']; ?>"> </span>
                    </td>
                    <td><span title="Delete this class" style="color: red; cursor: pointer;"
                              class="glyphicon glyphicon-trash delicon" data-id="<?php echo $row['id']; ?>"> </span>
                    </td>
                </tr>
                <?php
