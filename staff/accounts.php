                        ...
                        <table class="table table-condensed table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span onclick="resetpass(<?=$row->id;?>)" title="Reset user's password" style="color: deepskyblue; cursor: pointer;" class="glyphicon glyphicon-retweet"></span>
                                        
                                    </td>                                    
                                    <td>
                                        <span onclick="disacc(<?=$row->id;?>)" title="Disable user Account" style="color: red; cursor: pointer;" class="glyphicon glyphicon-off"></span>
                                       </td>                                    
                                    ...
                                    <td>
                                        <span onclick="enableacc(<?=$row->id;?>)" title="Enable user Account" style="color: deepskyblue; cursor: pointer;" class="glyphicon glyphicon-star"></span>
                                       </td>                                    
