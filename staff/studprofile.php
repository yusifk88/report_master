        ...
        <table class="table table-striped">
            <tr>
                <td  rowspan="6" style="text-align: center;">
                    <img src="../admin/<?= $row['photo']; ?> " alt="<?php $row['fname']." ".$row['oname'] ?>" width="180" height="200" />
                    
                </td>
            </tr>
            <tr>
                <th>FULL NAME:</th> <td colspan="3"><?= strtoupper($row['fname'].' '.$row['lname'].' '.$row['oname'])?></td>
                <th>REG. DATE:</th> <td colspan="2"><?= $row['dor']?></td>
                
            </tr>
            <tr>
                <th>ID NUMBER:</th> <td><?= $row['stindex']; ?></td>
                <th>GENDER:</th> <td><?= strtoupper($row['gender']); ?></td>
                <th>D.O.B:</th> <td><?=$row['dob']; ?></td>
                
            </tr>
            <tr>
                <th>PROGRAME:</th> <td><?=strtoupper($row['depname']);?></td>
                <th>YEAR</th> <td><?= $row['ayear'];?></td>
                <th>Gender House/Hall</th> <td><?=strtoupper($row['ghouse']?$row['ghouse']:"None");?></td>

            </tr>            
                
            <tr>
                <th>FORM:</th> <td><?= "FORM".$row['form']; ?></td>
                <th>LAST SCH:</th> <td colspan="3"><?=strtoupper($row['lschool']); ?></td>
               
            </tr>            
            <tr>
                <th>CLASS:</th> <td><?= strtoupper($row['classname']); ?></td>
                <th>HOUSE:</th> <td colspan="3"><?=strtoupper($row['name']); ?></td>
               
            </tr>
            <tr>
                <th>JHS NUMBER:</th> <td colspan="2" ><?= $row['jhsno']; ?></td>
                <th>SHS NUMBER:</th> <td colspan="3" ><?= $row['shsno']; ?></td>

            </tr>
            <tr>
                <th>FARTHER'S NAME:</th> <td colspan="6" ><?= strtoupper($row['ffname']); ?></td>

            </tr>
            <tr>
                <th>FARTHER'S HOMETOWN:</th> <td colspan="6" ><?= strtoupper($row['fhometown']); ?></td>
            </tr>
            <tr>
                <th>FARTHER'S CONTACT NO.:</th> <td colspan="6" ><?= $row['ftel']; ?></td>
                 
            </tr>            
                
            <tr>
                <th>MOTHER'S NAME:</th> <td colspan="6" ><?= strtoupper($row['mfname']); ?></td>
                
            </tr>            
            <tr>
                <th>MOTHER'S HOMETOWN:</th> <td colspan="6" ><?= strtoupper($row['mhometown']); ?></td>
                 
            </tr>            
            <tr>
                <th>MOTHER'S CONTACT NO.:</th> <td colspan="6" ><?= $row['mtel']; ?></td>
