        ...
        <div class="row ">
            ...
            <div class="col-2 col-md-1">
                <img class="img-fluid img-responsive img-rounded m-2"
                     src="<?= file_exists($row->photo) ? $row->photo : 'objts/dpic/photo.jpg' ?>" alt="">
            </div>
            <div class="col-10 col-md-11 ml-2">
                ...
                <small class="text-muted">
                    ...
                    <small class="text-muted">
                        <strong>Remark:</strong> <?= $row->remark ? $row->remark : "No Comment " ?></small>
                </small>
                <small class="text-muted ml-2"><i class="fa fa-clock-o"></i> <?= $row->date_signed ?> To</small>
                <small class="text-muted"><i class="fa fa-clock-o"></i> <?= $row->return_date ?></small>
                <small class="text-muted ml-2"> Return Date/Time:<?= $row->returned_time ?></small>
