...
<div class="table-responsive">
        ...
        <tbody>
            ...
            <tr>  
                ...
                <td><span class="glyphicon glyphicon-edit editicon3" title="Edit this department" data-input="<?php echo "$row[name]";?>" data-id="<?php echo $row['id']; ?>" data-des="<?php echo $row['des'];?>" style="color: deepskyblue; cursor: pointer;"></span></td>
                <td><span class="glyphicon glyphicon-trash delicon3" title="Delete this department" data-del="delhouse.php" data-id="<?php echo $row['id']; ?>" style="color: #F00; cursor: pointer;"></span></td>
