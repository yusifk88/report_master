...
$avge = mysqli_fetch_object(mysqli_query($cg->con,"select avg(totlscore) as avgt from records where term ='$term' and acyear = '$ayear' and subjt = '$sub' and cls='$cls'"))->avgt;
...
<body>
    <div class='container-fluid' >
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" >
                                <img style="margin: 10px;" class="img-responsive" width="140" height="150" src="../admin/objts/<?=$sch->logopath?>" alt="School crest" />
		...
		<div class='row' style="background-image:  url('./img/wmark1.png'); background-repeat: no-repeat; background-position: center;">
			<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
			<table class='table table-striped table-condensed'>
				<thead>
					<tr>
                                            <th colspan='2'>TUTOR:</th><td colspan='9' ><?=$staf_name;?></td><th colspan='2'>NO. ON ROLL: </th> <td><?=$numroll;?></td> <th colspan='3'>AVERAGE MARK:</th> <td><?= number_format($avge,2);?></td>

							</tr>
						<tr>
					<th colspan='2'>SUBJECT: </th> <td style="vertical-align: bottom;" colspan='8'><?=$subname;?></td> <th colspan='2'>CLASS: </th> <td style="vertical-align: bottom;"  ><?=$classname;?></td>   <th colspan='2'>AC. YEAR:</th> <td style="vertical-align: bottom;" ><?=$ayear;?></td> <th>TERM: </th> <td><?=$term_suf;?> Term</td>
...
<!--					<td style='text-align:center; vertical-align: middle;'></td>-->
					...
					<td style='text-align:center; vertical-align: middle;'><?=number_format($recrows->tscore,1);?></td>
					<td style='text-align:center; vertical-align: middle;'><?=$util->getgrd($recrows->tscore);?></td>
					<td style='text-align:center; vertical-align: middle;'><?=$util->getremark($recrows->tscore);?></td>
