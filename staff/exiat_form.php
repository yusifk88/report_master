...
if(isset($_SESSION['id'])) {
    ...
    <div class="row">
        <div class="col-md-12 text-muted p-2 mb-2">
            <i class="fa fa-info-circle fa-2x  m-2"></i> A copy of this exeat could be sent to the parent through SMS
            But it
            is an on-demand feature and is not available on your package
        </div>
        <div class="col-12 col-md-3">
            <img class="img-responsive"
                 src="<?= file_exists('../admin/' . $stinfo->photo) ? '../admin/' . $stinfo->photo : '../admin/objts/dpic/photo.jpg' ?>"
                 alt=""> <br/>
    ...
    <h4 class="text-danger">This account is not allowed to create Exeats</h4>
