                ...
                <table class="table table-striped table-condensed table-hover">
                    ...
                    while ($l = mysqli_fetch_object($lends)) {
                        ...
                        <tr class="<?= $l->returned ? 'success' : 'danger' ?>" id="lrow_<?= $l->id ?>">
                            <td><?= $i ?></td>
                            <td><a href=""
                                   onclick="printstud(<?= $l->stid ?>); return false;"><?= $l->fname . " " . $l->lname . " " . $l->oname ?></a>
                            </td>
                            <td><?= $l->title ?></td>
                            <td><?= $l->lenddate ?></td>
                            <td><?= $l->returndate ?></td>
                            ...
                            if ($l->returned) {
                                ...
                                ?>
                                <td><i onclick="recievebook(<?= $l->id ?>)" title="Collect this book"
                                       class="fa fa-arrow-right waves-effect text-success"></i></td>
                                <?php
                            }
                            ?>
                            <td><i onclick="dellend(<?= $l->id ?>,'lrow_<?= $l->id ?>')" title="Delete this record"
