...
//$pw1= $_GET['pw1'];
//$pw2= $_GET['pw2'];
$sum = $ta1+$ta2+$ta3+$ta4+$hw1+$hw2+$hw3+$hw4;
if($sum<=100 && $exam<=100){
...
mysqli_query($cfg->con, "update records set ta1='$ta1',ta2='$ta2',ta3='$ta3',ta4='$ta4',hw1='$hw1',hw2='$hw2',hw3='$hw3',hw4='$hw4',exam='$exam',subtotl='$subtotl' where id = '$id'");
