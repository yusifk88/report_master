...
<form id="ass_updateform" method="post" action="up_assess.php">
    ...
    <div class="row">
        ...
        <input  style="color:red; font-weight: bold;" name="" readonly="true" type="text" class="form-control" value="<?= $row->fname." ".$row->lname." ".$row->oname?>" />
        </div>
    </div>
        ...
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            ...
            <input id="up-ta1"  class="form-control" type="number" name="ta1" value="<?= $row->ta1;?>" />
        </div>

        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            <label for="up-ta2" class="control-label text-muted"> Two</label>
            <input id="up-ta2" class="form-control"  type="number" name="ta2" value="<?= $row->ta2;?>" />
        </div>

        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
           <label for="up-ta3" class="control-label text-muted">Three</label>
           <input id="up-ta3" class="form-control" type="number" name="ta3" value="<?= $row->ta3;?>" />
        </div>

        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          <label for="up-ta4" class="control-label text-muted">Four</label>
          <input id="up-ta4" class="form-control" type="number" name="ta4" value="<?= $row->ta4;?>" />
        </div>
...
<!--    home work-->
 ...
 <div class="row"  style="border-bottom: 1px solid #ccc;">
        ...
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            ...
            <input id="up-hw1"  class="form-control" type="number" name="hw1" value="<?= $row->hw1;?>" />
        </div>

        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            <label for="up-hw2" class="control-label text-muted">Two</label>
            <input id="up-hw2" class="form-control"  type="number" name="hw2" value="<?= $row->hw2;?>" />
        </div>

        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
           <label for="up-hw3" class="control-label text-muted">Three</label>
           <input id="up-hw3" class="form-control" type="number" name="hw3" value="<?= $row->hw3;?>" />
        </div>

        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          <label for="up-hw4" class="control-label text-muted">Four</label>
          <input id="up-hw4" class="form-control" type="number" name="hw4" value="<?= $row->hw4;?>" />
        </div>
...
<!--            <input id="up-pw1"  class="form-control" type="number" name="pw1" value="" />-->
<!--        </div>-->
<!---->
<!--        <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">-->
<!--            <label for="up-pw2" class="control-label text-muted">Project W. Two</label>-->
<!--            <input id="up-pw2" class="form-control"  type="number" name="pw2" value="" />-->
<!--        </div>-->
<!---->
<!---->
<!--    </div>-->
...
<div class="row">
        ...
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
            ...
            <input id="up-exam"  class="form-control" type="number" name="exam" value="<?= $row->exam;?>" />
        </div>

    </div>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            <img src="../admin/<?= $row->photo;?>" class="img-responsive img-circle"  />
