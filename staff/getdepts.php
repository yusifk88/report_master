...
<div class="table-responsive">
        ...
        <tbody>
            ...
            <tr>  
                ...
                <td><span class="glyphicon glyphicon-edit editicon" title="Edit this department" data-input="<?php echo "$row[depname]";?>" data-id="<?php echo $row['id']; ?>" style="color: deepskyblue; cursor: pointer;"></span></td>
                <td><span class="glyphicon glyphicon-trash delicon" title="Delete this department" data-del="deldept.php" data-id="<?php echo $row['id']; ?>" style="color: #F00; cursor: pointer;"></span></td>
