                ...
                <div class="card-body">
                    <form id="logonform">
                        ...
                        <div class="md-form">
                            ...
                            <input required type="password" name="stpassword" id="materialFormCardEmailEx"
                                   class="form-control">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="card rgba-orange-strong mt-5 text-white">
                <div class="card-body">
                    ...
                    <strong>NOTE:</strong> IF YOU ARE HERE FOR THE FIRST TIME, PLEASE USE YOUR DATE OF BIRTH AS YOUR
                    PASSWORD PLEASE ENTER YOUR DATE OF BIRTH IN THE FORMAT YYY/MM/DD <br> <br>
