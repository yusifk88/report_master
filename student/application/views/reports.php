        ...
        <div id="accordion" class="mt-5">
            <div class="card mt-5">
                <div class="card-header" id="heading">
                    <h6 class="mb-0">
                        <button class="btn btn-link text-info " data-toggle="collapse" data-target="#collapse<?=$y->ayear?>"
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card animated fadeInUp">
                                    <div class="card-header bg-white">
                                        ...
                                        <button onclick="preview_rep('<?=$y->ayear?>','1',<?=$stid?>);" class="btn btn-info pull-right">Preview & Print</button>
                                    </div>
                                    <div class="card-body">
                                                      ...
                                                      $subpost = 0;
                                                       ...
                                                       foreach($pos as $p){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center" style="text-align: center;"><?=$this->utility->addsufix($subpost)?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card animated fadeInUp">
                                        <div class="card-header bg-white">
                                            ...
                                            <button onclick="preview_rep('<?=$y->ayear?>','2',<?=$stid?>);" class="btn btn-info pull-right">Preview & Print</button>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-hover table-condensed">
                                                    ...
                                                    foreach($term_2_rep1 as $rep){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?=$this->utility->getgrd($totlscore)?></td>
                                                            <td class="text-center"><?=$this->utility->getremark($totlscore)?></td>
                                                            <td class="text-center" style="text-align: center;"><?=$this->utility->addsufix($subpost2)?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card animated fadeInUp">
                <div class="card-header bg-white">
                    ...
                    <button onclick="preview_rep('<?=$y->ayear?>','3',<?=$stid?>);" class="btn btn-info pull-right">Preview & Print</button>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-condensed">
                            ...
                            foreach($term_3_rep1 as $rep){
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?=$this->utility->getgrd($totlscore)?></td>
                                    <td class="text-center"><?=$this->utility->getremark($totlscore)?></td>
                                    <td class="text-center" style="text-align: center;"><?=$this->utility->addsufix($subpost3)?></td>
                                </tr>
                                <?php
                            }
                            ?>
