...
<nav class="navbar navbar-dark sticky-top rgba-cyan-strong p-0">
    <a class="navbar-brand waves-effect pull-left waves-light col-sm-3 col-md-2 mr-0"
       style="vertical-align: middle; width: auto;" onclick="toggle_sidebar(); return false;" href="#"><i id="nav-btn"
                                                                                                          class="fa fa-long-arrow-left fa-2x text-white"></i></a>

    <a onclick="return false;" data-container="body" data-html="true" data-toggle="popover" data-placement="top"
       data-content="<div class='card animated fadeInUp'><img class='card-img-top' src='<?= str_replace("student/", '', base_url()) ?>admin/<?= $_SESSION['photo'] ?>'><div class='card-body'><a class='btn btn-block btn-clear rgba-cyan-strong waves-effect waves-light' href='<?= base_url() ?>myprofile'> <i class='fa fa-gear'> </i>My Profile</a><br/><br/> <a class='btn btn-block btn-danger waves-effect waves-light' data-toggle='modal' data-target='#logoutmodal'> <i class='fa fa-sign-out'> </i>Log Out</a> </div></div>"
       class="navbar-brand col-sm-3 pull-right text-right waves-effect waves-light" href="#"
       style="vertical-align: middle; width: auto;"><span
                class="hidden-sm"><?= $_SESSION['fname'] . " " . $_SESSION['lname'] . " " . $_SESSION['oname'] ?></span>
        <img class="img img-circle img-fluid m-1"
             src="<?= str_replace("student/", '', base_url()) ?>admin/<?= $_SESSION['photo'] ?>"></a>
...
<div class="container-fluid">
    <div class="row">
        <nav class="col-md-2 col-sm-3 col-xs-3 sidebar bg-white card hoverable" id="sidebar">
            <div class="sidebar-sticky pt-5">
                <ul class="nav  flex-column">
                    <li class="nav-item">
                        <a class="nav-link <?= ($active == 0) ? 'active' : '' ?> btn btn-block "
                           href="<?= base_url() ?>">
        ...
        <main class="padding-left col-lg-12 col-md-12 col-sm-12 col-xs-12 pb-3" id="main-content">
            ...
            <div id="logoutmodal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLiveLabel"
                 aria-hidden="true">
