    ...
    <div class="row" style="border-bottom: solid 1px #000; margin-bottom: 10px;">
        ...
        <div class="col-lg-10 col-md-10">
            <center>
                ...
                <strong>Community:</strong> <?= $info->fhometown; ?>,
                <stronng>Tel:</stronng> <?= $info->ftel; ?><?= $info->mtel ? "/" . $info->mtel : "" ?>,
        ...
        <tr>
            <th rowspan="2" style="text-align: center;">
                <img width="120" height="140"
                     src="<?= str_replace("student/", "", base_url()) ?>admin/<?= $info->photo; ?>"/>
            </th>
            <th style="vertical-align: middle;">NAME:</th>
            <td style="vertical-align: middle;"
                colspan="3"><?= strtoupper($info->fname) . ' ' . strtoupper($info->lname) . ' ' . strtoupper($info->oname) ?></td>
                    ...
                    <div class="row" style="border-bottom: solid 1px #000;">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <strong>
                                ...
                                Year, <?= $this->utility->addsufix($c->term) ?>
                                Term
                            </strong><br>
                            <?= $c->coment; ?>
                        </div>
