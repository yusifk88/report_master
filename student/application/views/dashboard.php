            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12">
                    <h4>NOTE</h4>
                    You are currently using your defalt password, please change to a more secure and seceret password, as it is a part of your bio-data people who know you very well can get to login as your with ease. <br> <a href="./myprofile/#account" class="btn rgba-cyan-strong">Change my password</a>
                </div>
            </div>
            </div>
        </div>
                        ...
                        <div class="card-footer rgba-cyan-strong text-white">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                    The graph above is generated from accumulation of your marks, this can be used to assess your general performance on all the subjects that you studeid.
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="list-group">
                                <div class="list-group-item list-group-item-info">
                                    ...
                                    You did <?=($numyears<2)? $numyears. 'Academic Year': $numyears.' Academic Years'?>  <?=($numterms<2)? $numterms.' Term':$numterms.' Terms'?>
                                ...
                                <div class="list-group-item">
                                    <div class="row text-muted">
                                        ...
                                        <div class="col-lg-11 col-md-11 col-sm-10 col-xs-10">
                                           <strong><?=$frm->ayear?> (<?=$this->utility->addsufix($frm->term)?> Term)</strong> <br>
                                            <strong>Attendance:</strong> <?=$frm->attdance?> <strong>Out Of</strong> <?=$frm->attnded?>
