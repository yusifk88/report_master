<div class="row mt-5 pt-5">
    ...
    <div class="card hoverable animated fadeInUp">
        <center> <img class="img-responsive img-thumbnail animated fadeInUp" style="margin-top: -70px; width: 150px; height: 150px; border-radius: 50%; box-shadow: 0 0 3px; z-index: 99 !important;" src="<?= str_replace("student/",'',base_url())?>admin/<?=$_SESSION['photo']?>"></center>
        <div class="card-header bg-white">
            <button onclick="print_profile(<?=$myinfo->stid?>)" class="btn rgba-cyan-strong pull-right">Print</button>
        </div>
            ...
            <div class="card-body">
                ...
                <form id="accntfrm">
                    ...
                    <div class="md-form">
                        ...
                        <input name="myindex" readonly value="<?=$_SESSION['stindex']?>" type="text" id="myindex" class="form-control">
